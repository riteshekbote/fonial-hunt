...
24/7 deep multi-model bug-hunting automation for **fonial GmbH** (Oliver Maicher bug-bounty hub).

Scope: All company-owned infrastructure, cloud PBX systems, VoIP services, SIP platforms, APIs, web applications, customer interfaces, and domains operated by fonial GmbH
...
> is never accepted. Active testing is gated behind the in-scope hosts in `inventory/fonial.md` and
...
Program description: Cloud telephony and VoIP provider for small and medium-sized businesses in Germany
